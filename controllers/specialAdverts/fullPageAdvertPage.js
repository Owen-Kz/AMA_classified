...
const FullPageAdvertPage = async (req,res) =>{
    ...
    try {
      ...
      let expiry = ""
      if(currentPackage === "fullpage_advert_3_months"){
        expiry = await getFutureDate(3)
      }else if(currentPackage === "fullpage_advert_6_months"){
    ...
    res.render("postFullPageAdvert", {username:req.user.u_name, paymentIntentId:paymentIntentId, advertType:"fullpage_advert", advertDuration:expiry})
      }else{
