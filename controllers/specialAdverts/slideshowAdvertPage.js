...
const slideshowAdvertPage = async (req,res) =>{
    ...
    try {
      ...
      let expiry = ""
      if(currentPackage === "slideshow_3_months"){
        expiry = await getFutureDate(3)
      }else if(currentPackage === "slideshow_6_months"){
    ...
    res.render("postBrandAdvert", {username:req.user.u_name, paymentIntentId:paymentIntentId, advertType:"slideshow_advert", advertDuration:expiry})
      }else{
